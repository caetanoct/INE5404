...
public class frameCadastro2 extends JFrame {
...
public frameCadastro2() {
	...
	femininoButton.addActionListener(
			new ActionListener() {
	...
	masculinoButton.addActionListener(
			new ActionListener() {
	...
	grupoRadio.add(femininoButton);
	grupoRadio.add(masculinoButton);
